package com.highpeaksolutions.assignment;
...
public class Highpeak {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n");
		System.out.println("And the difference between the chosen goodies with "
				+ "highest price and the lowest price is:"+result);
	}
